...
int main() {
    ...
    //Begin array loading - Bed TC-MM2
    ...
    float FrondPIB = 15.9771; // Includes Aspidella
    float SpriggPIB = 0.172788; //Spriggina and Andiva
    float FunisiaPIB = 8.29455;

    //Hardcoded per square metre abundance values
    float FrondPerSqMAbundance = 29.12621359;
    float SpriggPerSqMAbundance = 0.2912621359;
    float FunisiaPerSqMAbundance = 4225.145631; // Funisia's abundance is very high on this bed (in the thousands), but the precise value was not counted.
