...
#define maxSpecies 13 // 16 for Nilpena
#define maxLoops 4398 //Static maximum number of loops. Should be 2^(maxSpecies+1), or 2*(maxSpecies^3).
...
int main() {
    ...
    float TriradialPIB = 0.20735;
    float SpriggPIB = 0.172788;
    float ParvanPIB = 0.084667;
    float SpongePIB = 0.86394; // Coronacollina
    float DickinPIB = 0.435424;
    float AlgaePIB = 11.517;

    //Hardcoded per square metre abundance values
    float TriradialPerSqMAbundance = 0.5479452055;
    float SpriggPerSqMAbundance = 1.095890411;
    float ParvanPerSqMAbundance = 0.4109589041;
    float SpongePerSqMAbundance = 1.232876712;
    float DickinPerSqMAbundance = 4.246575342;
    float AlgaePerSqMAbundance = 29.7260274;
